...
var lego1,lego2,legoCount=0.1,legosBoolean=false,legosLength=3000,legosStart;


var collapseVideo;
var vidTriggered=false;

var xRotor=1, yRotor=1, zRotor=1;
var xNegRotor=1, yNegRotor=1, zNegRotor=1;
var picNum=0;
var cubes=[];
var cubes2=[];
var numCubes=12;
...
function setup() {
 ...
 legosTrig=setTimeout(showLegos,3000);
 //legosTrig2=setTimeout(showLegos,10000);
...
function draw() {
  ...
  image(lego2,100,-300,200,200);
    ...
    if (legosBoolean && (currentTime-legosStart) > legosLength){
    legosBoolean=false;
    legosStart=0;
  }
  console.log(legosBoolean);
